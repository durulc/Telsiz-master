...
!(function (t, e, i) {
    (L.drawVersion = "0.4.0"),
        (L.drawLocal = {
            draw: {
                toolbar: {
                    actions: { title: "İptal Et", text: "İptal" },
                    finish: { title: "Tamamla", text: "Tamam" },
                    undo: { title: "Son çizgiyi iptal et", text: "Geri Al" },
					
                    buttons: { polyline: "Çizgi Çiz", polygon: "Draw a polygon", rectangle: "Draw a rectangle", circle: "Draw a circle", marker: "Draw a marker" },
                },
                handlers: {
                    circle: { tooltip: { start: "Click and drag to draw circle." }, radius: "Radius" },
                    marker: { tooltip: { start: "Click map to place marker." } },
                    polygon: { tooltip: { start: "Yolu çizmeye başlamak için tıklayın", cont: "Click to continue drawing shape.", end: "Click first point to close this shape." } },
                    polyline: { error: "<strong>Error:</strong> shape edges cannot cross!", tooltip: { start: "Yolu çizmeye başlamak için tıklayın.", cont: "Çizmeye devam etmek için tıklayın.", end: "Çizmeye devam etmek için tıklayın." } },
            ...
            edit: {
                toolbar: {
                    actions: { save: { title: "Değişiklikleri kaydet.", text: "Kaydet" }, cancel: { title: "Yapılan değişiklikleri geri al.", text: "Vazgeç" } },
                    buttons: { edit: "Yolu düzenle.", editDisabled: "No layers to edit.", remove: "Delete layers.", removeDisabled: "No layers to delete." },
                },
                handlers: { edit: { tooltip: { text: "Güncellemek istediğiniz noktayı seçin", subtext: "Değişiklikleri geri almak için Vazgeç e tıklayınız" } }, remove: { tooltip: { text: "Yolu silmek için tıklayınız" } } },
            },
        }),
        (L.Draw = L.Draw || {}),
            ...
            addHooks: function () {
                L.Draw.Feature.prototype.addHooks.call(this),
                    this._map &&
                        ...
                        L.Browser.touch || this._map.on("mouseup", this._onMouseUp, this),
        ...
        (L.Draw.Polygon = L.Draw.Polyline.extend({
            ...
            Poly: L.Polygon,
            options: { showArea: !1, shapeOptions: { stroke: !0, color: "#f06eaa", weight: 4, opacity: 0.5, fill: !0, fillColor: null, fillOpacity: 0.2, clickable: !0 }, metric: !0 },
            initialize: function (t, e) {
        ...
        (L.Draw.Rectangle = L.Draw.SimpleShape.extend({
            ...
            options: { shapeOptions: { stroke: !0, color: "#f06eaa", weight: 4, opacity: 0.5, fill: !0, fillColor: null, fillOpacity: 0.2, clickable: !0 }, metric: !0 },
            initialize: function (t, e) {
            ...
            _getTooltipText: function () {
                var t,
                    ...
                    n = this._shape;
                return (
                    n && ((t = this._shape._defaultShape ? this._shape._defaultShape() : this._shape.getLatLngs()), (e = L.GeometryUtil.geodesicArea(t)), (i = L.GeometryUtil.readableArea(e, this.options.metric))),
        ...
        (L.Draw.Circle = L.Draw.SimpleShape.extend({
            statics: { TYPE: "circle" },
            options: { shapeOptions: { stroke: !0, color: "#f06eaa", weight: 4, opacity: 0.5, fill: !0, fillColor: null, fillOpacity: 0.2, clickable: !0 }, showRadius: !0, metric: !0, feet: !0 },
            initialize: function (t, e) {
            ...
            _onMouseMove: function (t) {
                ...
                this._tooltip.updatePosition(i),
                    this._isDrawing &&
                        ...
                        this._tooltip.updateContent({ text: this._endLabelText, subtext: o ? L.drawLocal.draw.handlers.circle.radius + ": " + L.GeometryUtil.readableDistance(e, n, this.options.feet) : "" }));
            },
        })),
        (L.Draw.Marker = L.Draw.Feature.extend({
            ...
            removeHooks: function () {
                L.Draw.Feature.prototype.removeHooks.call(this),
                    this._map &&
                        (this._marker && (this._marker.off("click", this._onClick, this), this._map.off("click", this._onClick, this).off("click", this._onTouch, this).removeLayer(this._marker), delete this._marker),
            ...
            _onMouseMove: function (t) {
                ...
                this._tooltip.updatePosition(e),
                    ...
                    this._marker
                        ...
                        : ((this._marker = new L.Marker(e, { icon: this.options.icon, zIndexOffset: this.options.zIndexOffset })),
                ...
                if ((L.extend(e._origLatLng, e._latlng), e._middleLeft && e._middleLeft.setLatLng(this._getMiddleLatLng(e._prev, e)), e._middleRight && e._middleRight.setLatLng(this._getMiddleLatLng(e, e._next)), i.options.poly)) {
                    ...
                    if (!i.options.poly.allowIntersection && i.intersects()) {
                        ...
                        i.setStyle({ color: this.options.drawError.color }),
                            ...
                            setTimeout(function () {
                                i.setStyle({ color: n }), o && o.updateContent({ text: L.drawLocal.edit.handlers.edit.tooltip.text, subtext: L.drawLocal.edit.handlers.edit.tooltip.subtext });
                            }, 1e3);
                    }
                }
        ...
        L.Polyline.addInitHook(function () {
            this.editing ||
                (L.Edit.Poly && ((this.editing = new L.Edit.Poly(this, this.options.poly)), this.options.editable && this.editing.enable()),
        ...
        (L.Map.TouchExtend = L.Handler.extend({
            ...
            _touchEvent: function (t, e) {
                ...
                this._map.fire(e, { latlng: s, layerPoint: n, containerPoint: o, pageX: i.pageX, pageY: i.pageY, originalEvent: t });
            },
        ...
        (L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
            ...
            readableArea: function (t, e) {
                ...
                return (
                    e
                        ? (i = t >= 1e4 ? (1e-4 * t).toFixed(2) + " ha" : t.toFixed(2) + " m&sup2;")
                        : ((t /= 0.836127), (i = t >= 3097600 ? (t / 3097600).toFixed(2) + " mi&sup2;" : t >= 4840 ? (t / 4840).toFixed(2) + " acres" : Math.ceil(t) + " yd&sup2;")),
                    i
                );
            },
        ...
        (L.Toolbar = L.Class.extend({
            ...
            _initModeHandler: function (t, e, i, o, n) {
                ...
                (this._modes[s] = {}),
                    ...
                    (this._modes[s].button = this._createButton({ type: s, title: n, className: o + "-" + s, container: e, callback: this._modes[s].handler.enable, context: this._modes[s].handler })),
            ...
            _createActions: function (t) {
                ...
                for (var h = 0; h < r; h++)
                    ("enabled" in a[h] && !a[h].enabled) ||
                        ((e = L.DomUtil.create("li", "", s)),
                        (n = this._createButton({ title: a[h].title, text: a[h].text, container: e, callback: a[h].callback, context: a[h].context })),
        ...
        (L.EditToolbar = L.Toolbar.extend({
            ...
            initialize: function (t) {
                t.edit &&
                    ("undefined" == typeof t.edit.selectedPathOptions && (t.edit.selectedPathOptions = this.options.edit.selectedPathOptions),
        ...
        (L.EditToolbar.Edit = L.Handler.extend({
            ...
            removeHooks: function () {
                this._map &&
                    ...
                    (this._tooltip = null),
                    this._map.off("mousemove", this._onMouseMove, this).off("touchmove", this._onMouseMove, this).off("MSPointerMove", this._onMouseMove, this).off("draw:editvertex", this._updateTooltip, this));
            },
