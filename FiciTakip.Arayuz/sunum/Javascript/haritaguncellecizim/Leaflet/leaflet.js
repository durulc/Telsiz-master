...
!(function (t, i) {
    ...
    var Qi = Xi.extend({
        ...
        te = Xi.extend({
            options: { position: "bottomright", prefix: '<a href="https://csb.gov.tr/" title="Çevre ve Şehircilik Bakanlığı">Türkiye Cumhuriyeti Çevre, Şehircilik ve İklim Değişikliği Bakanlığı</a>' },
            initialize: function (t) {
