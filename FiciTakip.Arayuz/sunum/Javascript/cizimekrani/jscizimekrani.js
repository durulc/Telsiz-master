        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                if (msg.zSonuc == "1") {
                    ...
                    window.open("CizimHandler.ashx?filetopath="+msg.zDizinAdi);
...
function fn_CizimEkrani() {
    ...
    //var _Link = L.control({ position: 'topright' });
    //_Link.onAdd = function (map) {
    //    var div = L.DomUtil.create('div', 'info legend');
    //    // div.innerHTML = '<select><option>1</option><option>2</option><option>3</option></select>';
    //    div.innerHTML = "<br/><br/><a href='Cizim/1044B4C1-5C27-436D-A967-F24859733B0A/BC3E9D7B-829D-4AD3-8F62-4731047D2850/projedosyasi.kml'>projedosyasi.kml</a>";
    //    div.firstChild.onmousedown = div.firstChild.ondblclick = L.DomEvent.stopPropagation;
    //    return div;
    //};
    //_Link.addTo(haritaMap);
